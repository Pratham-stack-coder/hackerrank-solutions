...
long winningLotteryTicket(int tickets_count, char** tickets) {
    long long count = 0;
    int freq[1024] = {0}; // frequency of each possible bitmask (0-1023)
    ...
    int fullMask = (1 << 10) - 1; // 1023 = all digits present

    // Count all pairs of bitmask combinations
